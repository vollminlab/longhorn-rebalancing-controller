...
func TestStartMove_SurgesSpecAndRecordsState(t *testing.T) {
	...
	c := fake.NewClientBuilder().WithScheme(moveScheme(t)).WithObjects(vol, r1, r2).Build()
...
func TestProgressMove_IdentifiesNewReplica(t *testing.T) {
	...
	c := fake.NewClientBuilder().WithScheme(moveScheme(t)).WithObjects(vol, r1, r2, rNew).Build()
	rec := &RebalancingReconciler{Client: c}
...
func TestReconcile_ProgressesInFlightMoveDespiteDegradedVolume(t *testing.T) {
	...
	c := fake.NewClientBuilder().WithScheme(moveScheme(t)).WithObjects(vol, r1, r2, rNew, node).Build()
...
func TestMaybeEvict_FailureCapBlocksNewMoves(t *testing.T) {
	...
	c := fake.NewClientBuilder().WithScheme(moveScheme(t)).WithObjects(vol, r1).Build()
